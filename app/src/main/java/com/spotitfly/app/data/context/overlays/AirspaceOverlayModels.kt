...
object AirspaceStyle {
    ...
    private val IOS_BLUE   = argb("#0A84FF")
    private val IOS_GREEN  = argb("#34C759")
    private val IOS_INDIGO = argb("#5E5CE6")
    private val IOS_ORANGE = argb("#FF9F0A")
    ...
    fun of(layer: AirspaceLayer): Style = when (layer) {
        ...
        AirspaceLayer.URBANO -> Style(
            strokeColor = IOS_INDIGO,
            fillColor   = withAlpha(IOS_INDIGO, 0.10f),
            zIndex = 1f,
            dashed = true,
            baseWidthPx = 3.0f
        )
        AirspaceLayer.MEDIOAMBIENTE -> Style(
            ...
            fillColor   = withAlpha(IOS_GREEN, 0.15f),
            zIndex = 2f,
            dashed = true,
            baseWidthPx = 3.0f
        )
        ...
        AirspaceLayer.RESTRICCIONES -> Style(
            ...
            fillColor   = withAlpha(IOS_ORANGE, 0.18f),
            zIndex = 3f,
            dashed = false,
            baseWidthPx = 3.0f
        )
        ...
        AirspaceLayer.INFRAESTRUCTURAS -> Style(
            ...
            fillColor   = withAlpha(IOS_BLUE, 0.18f),
            zIndex = 4f,
            dashed = false,
            baseWidthPx = 3.0f
        )
