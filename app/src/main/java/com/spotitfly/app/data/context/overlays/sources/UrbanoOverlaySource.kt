...
internal object UrbanoOverlaySource {
    private const val ENDPOINT =
        "https://servais.enaire.es/insignia/rest/services/NSF_SRV/SRV_UAS_ZG_V1/FeatureServer/3/query"
    ...
    suspend fun fetch(bbox: LatLngBounds): List<AirspaceRenderable> {
        ...
        return GeoJsonOverlayParser.parseFeatures(root, AirspaceLayer.URBANO)
    }
